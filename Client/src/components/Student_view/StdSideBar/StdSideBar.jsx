...
import styles from "./StdSideBar.module.css";
import { useContext, useEffect, useState } from "react";
import AuthContext from "../../LoginPage/AuthProvider/AuthProvider";
import axios from "axios";
const StdSideBar = ({ user, activeProject }) => {
  return (
    <div className={styles.sideBar}>
      ...
      <div className={styles.section_one}>
        ...
        <ul className={styles.planlist}>
          <Link className={styles.listitems} to="/studentlogsheet">
            <BsFileEarmarkSpreadsheet fontSize={"22px"} />
            Logsheet
          </Link>
          <Link className={styles.listitems} to="/studentreports">
            <TbReportAnalytics fontSize={"22px"} />
            Reports
          </Link>
          <Link className={styles.listitems} to="/studentchat">
      ...
      <div className={styles.section_two}>
        ...
        <ul className={styles.doings}>
          <Link className={styles.listitems} to="/studenttask">
            <BiTask fontSize={"22px"} />
            Tasks
          </Link>
          <Link className={styles.listitems} to="/studentmembers">
